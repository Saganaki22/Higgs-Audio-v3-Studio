...
[English README](README.md) | [Windows/main branch](https://github.com/Saganaki22/Higgs-Audio-v3-Studio/tree/main)

作者: [Saganaki22](https://github.com/Saganaki22)

Higgs Audio v3 Studio `0.2.31` 是一个使用 Rust/Tauri 构建的 Windows 和
...
这个 `linux` 分支包含 Linux 桌面构建与打包说明。Windows 发布线继续放在
[`main`](https://github.com/Saganaki22/Higgs-Audio-v3-Studio/tree/main)
分支。
...
Linux 发布文件已经放在 GitHub Releases 页面。Ubuntu/Debian 推荐使用 `.deb`，
想要便携运行可以使用 AppImage。
